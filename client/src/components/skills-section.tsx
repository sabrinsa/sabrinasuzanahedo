      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-navy-800 mb-4">
            <Settings className="inline mr-3 text-gold" />
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-beige-50 rounded-xl p-6 border border-beige-200">
            <h3 className="text-xl font-bold text-navy-800 mb-4 flex items-center">
              <Settings className="mr-2 text-gold h-5 w-5" />
              Technical
            </h3>
            <div className="flex flex-wrap gap-2">
              {technicalSkills.map((skill, index) => (
                <Badge key={index} className="bg-navy-800 text-white px-3 py-1 text-sm">
                  {skill}
                </Badge>
              ))}
            </div>
            <div className="mt-6">
              <h4 className="font-semibold text-navy-800 mb-2">Tools</h4>
              <div className="flex flex-wrap gap-2">
                {tools.map((tool, index) => (
                  <Badge key={index} variant="outline" className="border-navy-800 text-navy-800 px-3 py-1 text-sm">
                    {tool}
                  </Badge>
                ))}
              </div>
          ...
          <div className="bg-beige-50 rounded-xl p-6 border border-beige-200">
            <h3 className="text-xl font-bold text-navy-800 mb-4 flex items-center">
              <Globe className="mr-2 text-gold h-5 w-5" />
              Languages
            </h3>
          ...
          <div className="bg-beige-50 rounded-xl p-6 border border-beige-200">
            <h3 className="text-xl font-bold text-navy-800 mb-4 flex items-center">
              <Users className="mr-2 text-gold h-5 w-5" />
              Soft Skills
            </h3>
            <div className="flex flex-wrap gap-2">
              {softSkills.map((skill, index) => (
                <Badge key={index} className="bg-gold text-navy-800 px-3 py-1 text-sm">
                  {skill}
                </Badge>
              ))}
            </div>
