      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            <Mail className="inline mr-3 text-gold" />
            Get In Touch
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="bg-navy-700 rounded-xl p-6 hover:bg-navy-600 transition-colors">
            <Mail className="text-gold h-8 w-8 mb-4 mx-auto" />
          ...
          <div className="bg-navy-700 rounded-xl p-6 hover:bg-navy-600 transition-colors">
            <Phone className="text-gold h-8 w-8 mb-4 mx-auto" />
          ...
          <div className="bg-navy-700 rounded-xl p-6 hover:bg-navy-600 transition-colors">
            <Linkedin className="text-gold h-8 w-8 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2">LinkedIn</h3>
            <a 
              href="https://www.linkedin.com/in/sabrinafinanceconsulting/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-beige-100 hover:text-gold transition-colors"
            >
              View Profile
            </a>
          </div>
